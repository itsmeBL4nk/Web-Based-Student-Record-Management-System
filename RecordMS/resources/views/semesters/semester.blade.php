    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6">
                <x-flash-message/>
                <a  href="#AddSemesterModal" class="btn btn-outline-primary" data-bs-toggle="modal">
                    <i data-feather="plus-square"></i> Add Sem</a>
            </div>
            <div class="col-12 col-md-6">
                    ...
                    <tbody>
                        @foreach ($data as $semester)
                                <tr style="border:1px solid #111010; border-collapse: collapse;">
                                    ...
                                    {{$semester->id}}</td>
                                    <td style="border:1px solid #111010; border-collapse: collapse;">
                                    {{$semester->semester}}</td>
 
                                   <td style="border:1px solid #111010; border-collapse: collapse;"> <a href="/semesters/{{$semester->id}}/edit_sem"
                                     class="btn icon btn-primary"><i data-feather="edit"></i></a>

                                     <a href="/delete_seme/{{$semester->id}}" 
                                        class="btn icon btn-danger" onclick="return confirm('Delete this Semester?')">
...
<div class="me-1 mb-1 d-inline-block">
    ...
    <div class="modal fade text-left" id="AddSemesterModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel17"
        aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <h4 class="modal-title white" id="myModalLabel17">Add Semester</h4>
