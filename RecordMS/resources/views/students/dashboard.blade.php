        ...
        <ul class="menu">
            <li class='sidebar-title'>Main Menu</li>
               <li class="sidebar-item active ">
                    ...
                    <a href="/teachers/teacher_dashboard" class='sidebar-link'>
            ...
            <li class="sidebar-item  has-sub">
                ...
                <a href="#" class='sidebar-link'>
                    ...
                    width="20"></i> 
                    <span>Request of TOR</span>
                </a>
                <ul class="submenu ">
                    <li>
                        <a href="/students/request_form">Request Form</a>
                    </li>
                    <li>
                        <a href="/students/myrequest">View Request</a>
                    </li>
                   </ul>
              </li>
              <li class="sidebar-item  has-sub">
                ...
                <ul class="submenu ">
                    <li>
                        <a href="/students/pre_enrollment">Pre Enrollment Form</a>
                    </li>
                    <li>
                        <a href="/students/grades">Grades</a>
                    </li>
                    ...
                    <ul class="navbar-nav d-flex align-items-center navbar-light ms-auto">
                        ...
                        <li class="dropdown">
                            <a href="#" data-bs-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                                ...
                                <div class="d-none d-md-block d-lg-inline-block">{{auth()->user()->student->lname}}, {{auth()->user()->student->fname}}</div>
                            </a>
