        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-7 mx-auto text-center">
                    <h1 class="display-4 text-white">Bato National High School</h1>
                    <p class="text-white my-3">"A school of beauty, a school humility a school of loyalty , serving God and community"</p>
