                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li style="box-shadow: rgba(178, 184, 192, 0.3) 0px 0px 0px 3px;" class="nav-item">
                        <a style="background-color:rgb(218, 218, 237);color:blue"
                         class="nav-link" href="/users/login">Login<i class='fas fa-arrow-right'
                    ...
                    <div style="background-color: rgb(196, 254, 254)" class="col-md-5 col-sm-12 mx-auto">
                        <div style="background-color: rgb(224, 245, 245)" class="card pt-4">
                            <div class="card-body">
                                ...
                                <form method="POST" action="/users/student_auth">
                                  @csrf

                                    <div class="form-group position-relative has-icon-left">
                                        <label style="color: rgb(14, 22, 22); backgroud-color: red" 
                                         for="username">Learner's Reference Number(LRN)</label>
                                        <div class="position-relative"> 
                                            <input type="text" style="border:1px solid black;" class="form-control" placeholder="Enter LRN" name="lrn" id="lrn">
                                        </div>
                                        @error('username')
                                        <p style="color:red;">
                                        {{$message}}</p>
                                    ...
                                    <div class='form-check clearfix my-4'>
                                        ...
                                        <div class="float-end">
                                            <a style="color: rgb(253, 7, 7)" href="/users/login">Login as a Teacher?</a>
                                        </div>
                                    </div>
                                    <div class="clearfix">
